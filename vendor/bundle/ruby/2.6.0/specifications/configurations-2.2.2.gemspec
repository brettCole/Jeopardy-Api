# -*- encoding: utf-8 -*-
# stub: configurations 2.2.2 ruby lib

Gem::Specification.new do |s|
  s.name = "configurations".freeze
  s.version = "2.2.2"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.require_paths = ["lib".freeze]
  s.authors = ["Beat Richartz".freeze]
  s.date = "2016-11-12"
  ...
  s.email = "attr_accessor@gmail.com".freeze
  s.homepage = "http://github.com/beatrichartz/configurations".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "3.0.3".freeze
  s.summary = "Configurations with a configure block from arbitrary to type-restricted for your gem or other ruby code.".freeze
